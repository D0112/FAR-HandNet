...
TASKS = 'detect', 'segment', 'classify', 'pose', 'pose_scconv', 'pose_rle'
TASK2DATA = {'detect': 'coco8.yaml', 'segment': 'coco8-seg.yaml', 'classify': 'imagenet10', 'pose': 'coco8-pose.yaml', 'pose_rle': 'coco8-pose.yaml', 'pose_scconv': 'coco8-pose.yaml'}
TASK2MODEL = {
    'detect': 'yolov8n.pt',
    'segment': 'yolov8n-seg.pt',
    'classify': 'yolov8n-cls.pt',
    'pose': 'yolov8n-pose.pt',
    'pose_rle': 'yolov8n-pose.pt',
    'pose_scconv': 'yolov8n-pose.pt'}
TASK2METRIC = {
    'detect': 'metrics/mAP50-95(B)',
    'segment': 'metrics/mAP50-95(M)',
    'classify': 'metrics/accuracy_top1',
    'pose': 'metrics/mAP50-95(P)',
    'pose_rle': 'metrics/mAP50-95(P)',
    'pose_scconv': 'metrics/mAP50-95(P)'}
