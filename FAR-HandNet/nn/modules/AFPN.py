...
from ultralytics.nn.modules.scconv import Bottleneck_ScConv
class C2f_AFPN(nn.Module):
...
class ASFF_3(nn.Module):
    ...
    def forward(self, x):
        ...
        input2 = input2[:, :, :input1.shape[2], :input1.shape[3]]
        input3 = input3[:, :, :input1.shape[2], :input1.shape[3]]

        level_1_weight_v = self.weight_level_1(input1)
        level_2_weight_v = self.weight_level_2(input2)
        level_3_weight_v = self.weight_level_3(input3)

        level_2_weight_v = level_2_weight_v[:, :, :level_1_weight_v.shape[2], :level_1_weight_v.shape[3]]
        level_3_weight_v = level_3_weight_v[:, :, :level_1_weight_v.shape[2], :level_1_weight_v.shape[3]]
...
if __name__ == '__main__':
    ...
    model1 = ASFF_2(512, level=1, channel=[256, 512])
    output = model1(input)
    print(output.shape)
    # #
