...
# OKS_SIGMA_Trigngle = np.array([2.9763353444745, 2.9038712877572914, 2.4816881039592382])
OKS_SIGMA_HAND = np.array([13.41398281, 13.85466131, 10.89342526, 12.44952175, 12.92186392, 12.07123085,
                                 11.43517564, 12.83843262, 13.33236482, 14.73891547, 12.70036736, 11.58467486,
                                 14.15905248, 13.56856943, 12.68722278, 10.80201803, 13.69097202, 12.05097774,
                                 14.12862984, 15.39768681, 12.35003559]) / 10.0
...
def kpt_iou(kpt1, kpt2, area, sigma, eps=1e-7):
    ...
    # sigma = sigma.to(device=kpt1.device, dtype=kpt1.dtype)
